  ...
  const articles = [
    {
      ...
      excerpt: 'Практические техники для улучшения производительности: lazy loading, code splitting, оптимизация изображений и многое другое.',
    ...
    {
      id: 2,
      title: 'SEO для SPA: как сделать React-приложение видимым для поисковиков',
      excerpt: 'Server-side rendering, meta теги, структурированные данные и другие способы улучшить SEO одностраничных приложений.',
      category: 'SEO',
      readTime: '12 мин',
      date: '8 декабря 2024',
    ...
    {
      id: 3,
      title: 'Архитектура крупных фронтенд проектов: паттерны и подходы',
      excerpt: 'Feature-Sliced Design, монорепозитории, микрофронтенды — как организовать код в больших командах.',
