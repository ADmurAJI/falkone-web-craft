...
import { ArrowRight, Database, Monitor, Search, Settings, Smartphone, Zap } from 'lucide-react'

const allServices = [
  {
    icon: Monitor,
    title: 'Веб-приложения',
    description: 'Создаю сложные пользовательские интерфейсы: дашборды, CRM, админки, SaaS-платформы',
    features: ['Компонентная архитектура', 'State management', 'Реактивные формы', 'Визуализация данных'],
  ...
  },
  {
    ...
    description: 'Создаю продающие лендинги с технической SEO-оптимизацией для высоких позиций в поиске',
    features: ['Техническая SEO', 'Оптимизация скорости', 'Метатеги и разметка', 'Core Web Vitals'],
    color: 'from-green-500 to-green-600'
  },
  {
    icon: Database,
    title: 'Интеграция с REST API и CMS',
    description: 'Подключаю внешние сервисы, настраиваю взаимодействие с бэкендом и популярными CMS',
  ...
  },
  {
    ...
    description: 'Все проекты отлично работают на любых устройствах от смартфонов до широких мониторов',
  ...
  },
  {
    ...
    description: 'Техническая поддержка проектов, оптимизация производительности и настройка аналитики',
    features: ['Мониторинг ошибок', 'A/B тестирование', 'Аналитика', 'Обновления'],
        ...
        <div className="text-center mt-20">
          <div className="bg-card/70 backdrop-blur-md border border-border rounded-xl p-10 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Расскажите о вашей задаче, и я предложу оптимальное решение с учетом бюджета и сроков
            </p>
            <Button
              size="lg"
